...
export default function ComingSoon() {
    return (
        <div className="min-h-screen flex items-center justify-center bg-light-warm dark:bg-dark px-6">
            ...
            <div className="text-center max-w-2xl">
                ...
                <h1 className="mt-8 font-display font-extrabold leading-[.95] tracking-[-0.04em] text-[clamp(2.5rem,6vw,5rem)] text-text-dark dark:text-offwhite">
