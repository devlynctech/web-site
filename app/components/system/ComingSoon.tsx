    ...
    return (
        <div className="h-full flex items-center justify-center px-4">
            ...
            <div className="text-center max-w-2xl w-full">
                ...
                <div className="inline-flex items-center gap-2 border border-orange/30 bg-orange/10 text-orange rounded-3xl px-4 py-1 text-sm">
                    <span className="w-2 h-2 bg-orange rounded-full animate-pulse"></span>
                    Coming Soon
                </div>

                {/* Title */}
                <h1 className="mt-6 font-display font-extrabold leading-[.95] tracking-[-0.04em] text-[clamp(2rem,6vw,5rem)] text-text-dark dark:text-offwhite">
                ...
                <p className="mt-4 text-text-muted dark:text-gray text-lg">
